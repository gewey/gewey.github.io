...
const gamesminecraftBookmarks = [
  ...
  { title: 'Forge', href: 'https://files.minecraftforge.net/', alt: 'ForgeDevTeam' },
  { title: 'Fabric', href: 'https://fabricmc.net/', alt: 'FabricMC' },
  { title: 'CurseForge', href: 'https://www.curseforge.com/minecraft/mods', alt: 'curseforge' },
  { title: 'Modrinth', href: 'https://modrinth.com/', alt: 'modrinth' },
...
BookmarkBuilder.renderBookmarks(gamesminecraftBookmarks);
