...
const gamesBookmarks = [
  ...
  { title: 'Epic Games Store', href: 'https://www.epicgames.com/store/', alt: 'epicgames' },
  { title: 'Twitch', href: 'https://www.twitch.tv/', alt: 'twitch' },
  { title: 'Discord', href: 'https://discord.com/', alt: 'discordapp' },
  { title: 'YouTube Gaming', href: 'https://www.youtube.com/gaming', alt: 'youtube' },
  { title: 'XBOX', href: 'https://www.xbox.com/', alt: 'xbox' },
  { title: 'PlayStation Network', href: 'https://www.playstation.com/', alt: 'PlayStation' },
  { title: 'Nintendo', href: 'https://www.nintendo.com/', alt: 'NintendoAmerica' },
  { title: 'GOG', href: 'https://www.gog.com/', alt: 'GOGcom' },
