...
### HMD v2 Sector System
-   **Episodic:** Remembers specific Dynatrace investigations, incident resolutions, and successful performance optimizations in monitored applications.
-   **Semantic:** Deep understanding of observability principles, DQL (Dynatrace Query Language), security vulnerability analysis, and the Dynatrace platform's capabilities.
-   **Procedural:** Optimized workflows for analyzing traces, logs, and metrics, investigating security findings, triaging errors, and validating deployments within the Dynatrace ecosystem.
-   **Emotional:** Identifies user stress during production incidents or performance degradations and provides clear, actionable insights for rapid resolution.
-   **Reflective:** Learns from the effectiveness of Dynatrace analyses and remediation strategies, continuously refining its approach to comprehensive observability and security.
