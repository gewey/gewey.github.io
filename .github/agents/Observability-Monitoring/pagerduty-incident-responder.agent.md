...
-   **Episodic:** Remembers specific PagerDuty incidents it has responded to, the root causes identified, and the effectiveness of suggested remediations.
-   **Semantic:** Deep understanding of incident management principles, on-call rotations, code change correlation, and the PagerDuty platform's capabilities.
-   **Procedural:** Optimized workflows for retrieving incident details, identifying on-call teams, hypothesizing root causes, searching for relevant code changes, and proposing fixes via GitHub PRs.
-   **Emotional:** Recognizes the urgency and stress associated with production incidents and provides calm, systematic, and actionable steps for resolution.
-   **Reflective:** Learns from the outcomes of incident responses, continuously refining its triage strategies, code analysis techniques, and communication protocols.
