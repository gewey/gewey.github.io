        ...
        return tslib_1.__generator(this, function (_4) {
            switch (_4.label) {
                case 0:
                    ...
                    defaultCookieDomain = '';
                    if (!(identityStorage === constants_1.DEFAULT_IDENTITY_STORAGE)) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, exports.getTopLevelDomain)(undefined, diagnosticsClient)];
                case 1:
                    defaultCookieDomain = _4.sent();
                    _4.label = 2;
                case 2:
                    cookieOptions = tslib_1.__assign({ domain: (_b = (_a = options.cookieOptions) === null || _a === void 0 ? void 0 : _a.domain) !== null && _b !== void 0 ? _b : defaultCookieDomain, expiration: 365, sameSite: 'Lax', secure: false, upgrade: true }, options.cookieOptions);
                    cookieConfig = {
                    ...
                    return [4 /*yield*/, (0, cookie_migration_1.parseLegacyCookies)(apiKey, cookieStorage, (_d = (_c = options.cookieOptions) === null || _c === void 0 ? void 0 : _c.upgrade) !== null && _d !== void 0 ? _d : true)];
                case 3:
                    legacyCookies = _4.sent();
                    return [4 /*yield*/, cookieStorage.get((0, analytics_core_1.getCookieName)(apiKey))];
                case 4:
                    previousCookies = _4.sent();
                    ...
                    deviceId = (_j = (_h = (_g = (_e = options.deviceId) !== null && _e !== void 0 ? _e : (isWithinTimeLimit ? (_f = queryParams.ampDeviceId) !== null && _f !== void 0 ? _f : queryParams.deviceId : undefined)) !== null && _g !== void 0 ? _g : previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.deviceId) !== null && _h !== void 0 ? _h : legacyCookies.deviceId) !== null && _j !== void 0 ? _j : (0, analytics_core_1.UUID)();
                    lastEventId = (_k = previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.lastEventId) !== null && _k !== void 0 ? _k : legacyCookies.lastEventId;
                    lastEventTime = (_l = previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.lastEventTime) !== null && _l !== void 0 ? _l : legacyCookies.lastEventTime;
                    optOut = (_o = (_m = options.optOut) !== null && _m !== void 0 ? _m : previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.optOut) !== null && _o !== void 0 ? _o : legacyCookies.optOut;
                    sessionId = (_p = previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.sessionId) !== null && _p !== void 0 ? _p : legacyCookies.sessionId;
                    deferredSessionId = previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.deferredSessionId;
                    userId = (_r = (_q = options.userId) !== null && _q !== void 0 ? _q : previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.userId) !== null && _r !== void 0 ? _r : legacyCookies.userId;
                    amplitudeInstance.previousSessionDeviceId = (_s = previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.deviceId) !== null && _s !== void 0 ? _s : legacyCookies.deviceId;
                    amplitudeInstance.previousSessionUserId = (_t = previousCookies === null || previousCookies === void 0 ? void 0 : previousCookies.userId) !== null && _t !== void 0 ? _t : legacyCookies.userId;
                    trackingOptions = {
                        ipAddress: (_v = (_u = options.trackingOptions) === null || _u === void 0 ? void 0 : _u.ipAddress) !== null && _v !== void 0 ? _v : true,
                        language: (_x = (_w = options.trackingOptions) === null || _w === void 0 ? void 0 : _w.language) !== null && _x !== void 0 ? _x : true,
                        platform: (_z = (_y = options.trackingOptions) === null || _y === void 0 ? void 0 : _y.platform) !== null && _z !== void 0 ? _z : true,
                    };
                    ...
                    (_0 = earlyConfig === null || earlyConfig === void 0 ? void 0 : earlyConfig.loggerProvider) !== null && _0 !== void 0 ? _0 : options.loggerProvider, options.logLevel, options.minIdLength, options.offline, optOut, options.partnerId, options.plan, options.serverUrl, 
                    // Use earlyConfig.serverZone to ensure consistent serverZone
                    (_1 = earlyConfig === null || earlyConfig === void 0 ? void 0 : earlyConfig.serverZone) !== null && _1 !== void 0 ? _1 : options.serverZone, sessionId, deferredSessionId, options.sessionTimeout, options.storageProvider, trackingOptions, options.transport, options.useBatch, options.fetchRemoteConfig, userId, pageCounter, debugLogsEnabled, options.networkTrackingOptions, options.identify, 
                    // Use earlyConfig values (already has remote config applied), otherwise fall back to options
                    (_2 = earlyConfig === null || earlyConfig === void 0 ? void 0 : earlyConfig.enableDiagnostics) !== null && _2 !== void 0 ? _2 : options.enableDiagnostics, (_3 = earlyConfig === null || earlyConfig === void 0 ? void 0 : earlyConfig.diagnosticsSampleRate) !== null && _3 !== void 0 ? _3 : amplitudeInstance._diagnosticsSampleRate, diagnosticsClient, options.remoteConfig, defaultCookieDomain, options.enableRequestBodyCompression, amplitudeInstance._enableRequestBodyCompressionExperimentalValue);
