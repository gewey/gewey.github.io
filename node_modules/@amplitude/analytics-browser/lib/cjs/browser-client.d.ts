...
export declare class AmplitudeBrowser extends AmplitudeCore implements BrowserClient, AnalyticsClient {
    ...
    _enableRequestBodyCompressionExperimentalValue: boolean;
    ...
    setSessionId(sessionId: number | undefined): import("@amplitude/analytics-core").AmplitudeReturn<void> | import("@amplitude/analytics-core").AmplitudeReturn<Result[]>;
    extendSession(): void;
