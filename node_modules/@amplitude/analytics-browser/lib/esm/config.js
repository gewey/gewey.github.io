        ...
        return __generator(this, function (_4) {
            switch (_4.label) {
                case 0:
                    ...
                    defaultCookieDomain = '';
                    if (!(identityStorage === DEFAULT_IDENTITY_STORAGE)) return [3 /*break*/, 2];
                    return [4 /*yield*/, getTopLevelDomain(undefined, diagnosticsClient)];
                case 1:
                    defaultCookieDomain = _4.sent();
                    _4.label = 2;
                case 2:
                    cookieOptions = __assign({ domain: (_b = (_a = options.cookieOptions) === null || _a === void 0 ? void 0 : _a.domain) !== null && _b !== void 0 ? _b : defaultCookieDomain, expiration: 365, sameSite: 'Lax', secure: false, upgrade: true }, options.cookieOptions);
                    cookieConfig = {
                    ...
                    return [4 /*yield*/, parseLegacyCookies(apiKey, cookieStorage, (_d = (_c = options.cookieOptions) === null || _c === void 0 ? void 0 : _c.upgrade) !== null && _d !== void 0 ? _d : true)];
                case 3:
