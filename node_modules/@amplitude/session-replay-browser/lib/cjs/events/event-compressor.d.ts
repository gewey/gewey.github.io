...
export declare class EventCompressor {
    ...
    timeout: number;
    worker?: Worker;
    constructor(eventsManager: SessionReplayEventsManager<'replay' | 'interaction', string>, config: SessionReplayJoinedConfig, deviceId: string | undefined, workerScript?: string);
